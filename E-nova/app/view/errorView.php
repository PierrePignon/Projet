...
<body>
	...
	<div class="container">
		...
		<h1>Aïe ! Quelque chose s'est mal passé ! Cliquez sur les menus disponibles pour vous rediriger.</h1>
	...
	<button id="revenir" onclick="window.location.href = 'index.php'">Retour Accueil</button>
