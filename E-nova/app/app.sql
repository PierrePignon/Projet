...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  sam. 25 mai 2019 à 14:37
...
INSERT INTO `actuator` (`id`, `type`, `name`, `value`, `room_id`) VALUES
(1, 'Ventilateur', 'Aération', 0, 1),
(3, 'Ventilateur', 'Ventilateur', 0, 3),
(6, 'Stores', 'Stores', 0, 3),
(5, 'Lumière', 'Lumière', 0, 3),
(7, 'Caméra', 'Caméra', 0, 4);
...
(4, 9, 'Route de l\'air', 75000, 'Paris', 'France', 1);
...
(5, 'J\'ai déménagé, comment changer mes informations.', 'A l\'aide de notre onglet mes logements il est possible d\'ajouter des adresses. De ce fait vous pouvez ajouter un nombre infini d\'adresses à votre compte. Il vous est aussi possible de supprimer les adresses à tout moment. ATTENTION ! La suppression d\'adresse est irréversible et entraîne la suppression de tous les capteurs qui lui sont associés. Cet action est donc à effectuer avec précaution. ', '2019-05-19 22:49:13'),
...
(1, 'Bonjour ! Comment peut-on modifier le mot de passe du compte ?', '2019-05-25 16:17:12', 1, 1, 'user'),
(2, 'Comment ajouter une salle s\'il vous plait ?\r\n', '2019-05-25 16:30:43', 2, 1, 'user'),
(3, 'J\'ai perdu les identifiants du compte utilisateur de mon fils, comment peut-on les récupérer ?', '2019-05-25 16:32:01', 3, 1, 'user'),
(4, 'Vous pouvez aller sur l\'onglet Profil et modifier directement votre mot de passe !', '2019-05-25 16:34:04', 1, 1, 'admin'),
(5, 'Vous ne pouvez pas récupérer votre mot de passe', '2019-05-25 16:34:43', 3, 1, 'admin'),
(6, 'mais vous pouvez le changer', '2019-05-25 16:34:51', 3, 1, 'admin'),
(7, 'Dans l\'onglet Profil, aller dans la partie utilisateur', '2019-05-25 16:35:13', 3, 1, 'admin'),
(8, 'Et changer le mot de passe du compte utilisateur que vous souhaitez', '2019-05-25 16:35:30', 3, 1, 'admin');
...
INSERT INTO `sensor` (`id`, `type`, `name`, `value`, `room_id`) VALUES
(1, 'Thermomètre', 'Température', 30, 1),
(2, 'Infrarouge', 'Présence', 30, 3),
(3, 'Luminosité', 'Luminosité', 30, 3),
(4, 'Humidité', 'Humidité', 30, 2),
(5, 'Luminosité', 'Lumière', 30, 5);
